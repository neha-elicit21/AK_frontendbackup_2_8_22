        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Manage Professor</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><a href="<?= site_url('admin/add_professor_form');?>" class="btn btn-primary"><span class="fa fa-user-plus" aria-hidden="true"></span>
</a></h3>
              </div>
              <!-- /.card-header -->
       <div class="card-body">
         ...
         <?php
          ...
          <td><a href="<?php echo base_url('admin/view_professor_student/') ?><?php echo $row['id']; ?>" title="view student"> <i class="fas fa-eye"></i> </a> <a href="<?php echo base_url('admin/manage_professor_Edit/') ?><?php echo $row['id']; ?>" title="Edit"> <i class="fas fa-edit"></i> </a> <a href="<?php echo base_url('admin/manage_professor_delete/') ?><?php echo $row['id']; ?>" title="Delete"> <i class="fas fa-trash"></i> </a></td>
