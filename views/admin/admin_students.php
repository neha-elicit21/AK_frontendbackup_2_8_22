      ...
      <div class="container">
        ...
        <ul class="task-card">          
          ...
          <?php foreach ($data as $key => $row) {
            $num_row=get_num_rows('user_membership',$row['id']);
            ?>
            

           <li><a href="<?php echo base_url('admin/admin_student_dashboard/').$row['id'];?>">
 ...
 -->
            ...
            <div class="card-footer">
               ...
               <?php
                 if ($num_row==1)
                  {
                    echo "<span>".$row['package_sub_title']."</span>";
                 }
                   else
                   {
                      echo "<span>Multiple Packages</span>";
                   }
               ?>
