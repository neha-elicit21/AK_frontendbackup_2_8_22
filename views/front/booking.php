         ...
         <div class="row packages-row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
               <div class="packages-box uplode-img plus-icon file-upload-wrapper">
                  ...
                  <div class="">
                     <input type="radio" name="price_package_id" id="input-file-now-custom-2" onchange="SubjectSelect(this.id)" class="file-upload" data-height="500" value="0">
                     <img src="<?php echo base_url('assets') ?>/img/bg-plus.jpg">
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-2 col-md-3 col-sm-6">
                  <div class="professor-box">
                     ...
                     <a href="javascript:void(0)" title="Select package" class="select-package-btn bg-white">View profile
                     </i>
                     </a>
                     <p style="position: relative;">
                     <input type="radio" class="select-package-input" name="professor_id" value="<?= $professorData['id']  ?>" />
                  ...
                  <div class="col-lg-5 col-md-5 col-sm-5 heading">
                     ...
                     <div class="row times-select">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 slect-time-right">
                           <div><input type="radio" name="package_startTime" value="09:00"> <span class="time">09:00</span></div>
                           <div><input type="radio" name="package_startTime" value="10:00"> <span class="time">10:00</span></div>
                           <div><input type="radio" name="package_startTime" value="11:00"> <span class="time">11:00</span></div>
                           <div><input type="radio" name="package_startTime" value="12:00"> <span class="time">12:00</span></div>
                           <div><input type="radio" name="package_startTime" value="13:00"> <span class="time">13:00</span></div>
                           <div><input type="radio" name="package_startTime" value="14:00"> <span class="time">14:00</span></div>
                           <div><input type="radio" name="package_startTime" value="15:00"> <span class="time">15:00</span></div>
                           <div><input type="radio" name="package_startTime" value="16:00" disabled="disabled"> <span class="time">16:00</span></div>
                           <div><input type="radio" name="package_startTime" value="17:00"> <span class="time">17:00</span></div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 slect-time-right">
                           <div><input type="radio" name="package_endTime" value="09:30"> <span class="time">09:30</span></div>
                           <div><input type="radio" name="package_endTime" value="10:30" disabled="disabled"> <span class="time">10:30</span></div>
                           <div><input type="radio" name="package_endTime" value="11:30"> <span class="time">11:30</span></div>
                           <div><input type="radio" name="package_endTime" value="12:30"> <span class="time">12:30</span></div>
                           <div><input type="radio" name="package_endTime" value="13:30"> <span class="time">13:30</span></div>
                           <div><input type="radio" name="package_endTime" value="14:30"> <span class="time">14:30</span></div>
                           <div><input type="radio" name="package_endTime" value="15:30"> <span class="time">15:30</span></div>
                           <div><input type="radio" name="package_endTime" value="16:30"> <span class="time">16:30</span></div>
                           <div><input type="radio" name="package_endTime" value="17:30"> <span class="time">17:30</span></div>
                           <span clas="time">
            ...
            <div class="form mt-2">
                  <div class="form-row form-account-create">
                     <div class="col-md-6 mb-5">
                        <label>Email*</label>
                        <input type="text" name="email" id="email" class="form-control" placeholder="University of Oxford">
                        <span id="err-email"></span>
                     </div>
                     <div class="col-md-6 mb-5">
                        <label>Set  password*</label>
                        <input type="text" name="password" id="password" class="form-control" value="" placeholder="1234567890"  required>
                        <span id="err-password"></span>
                     </div>
                     <div class="col-md-6 mb-5">
                        <label>Last name*</label>
                        <input type="text"  name="lname" id="lname" class="form-control" value="" placeholder="Garner-Jones">
                        <span id="err-lname"></span>
                     </div>
                     <div class="col-md-6 mb-5">
                        <label>First  name*</label>
                        <input type="text"  name="fname" id="fname" class="form-control" value="" placeholder="Louise">
                        <span id="err-fname"></span>
                     </div>
                     <div class="col-md-6 mb-5">
                        <label>Country  of  residence*</label>
                        <input type="text"  name="country_of_residence" id="country_of_residence" class="form-control" value="" placeholder="Canada">
                        <span id="err-country_of_residence"></span>
                     </div>
                     <div class="col-md-6 mb-5">
                        <label>Phone  number</label>
                        <input type="number" name="phone_no" id="phone_no" class="form-control" value="" placeholder="+44 (0) 7123 456 789">
                        <span id="err-phone_no"></span>
                     </div>
                     <div class="col-md-6 mb-5">
                        <label>Your current school/university</label>
                        <input type="text" name="current_school_university" id="current_school_university" class="form-control" value="" placeholder="McGill University">
                        <span id="err-current_school_university"></span>
                     </div>
                     <div class="col-md-6 mb-5">
                        <label>Your current GPA</label>
                        <input type="text" name="current_gpa" id="current_gpa" class="form-control" value="" placeholder="1.0">
                        <span id="err-current_gpa"></span>
                     </div>
                     <div class="col-md-6 mb-5">
                        <label>Yoru current major</label>
                        <input type="text" name="current_major" id="current_major" class="form-control" value="" placeholder="Mathematics">
               ...
               <div class="row ">
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     ...
                     <ul class="list-information">
                        ...
                        <li>
                           <span>School(s) considered</span>
                           <span id="considered_school_v"></span>
                     ...
                     <div class="selected-package">
                        ...
                        <a href="javascript:void(0)" title="Select package" class="select-package-btn">Change  package 
                        <i class="fas fa-chevron-right"></i>
                        </a>
                     </div>
                  </div>
                     ...
                     <div class="form-row mb-4">
                        <div class="col-md-6 mb-2">
                           ...
                           <ul class="country-btn-list">
                              ...
                              <li>
                                 <input type="radio" class="select-package-input" name="installment" value="Pay in  4 installments">
                        ...
                        <div class="col-md-6 mb-2">
                           ...
                           <input type="text" name="voucher_code" class="form-control" placeholder="Post code">
                        </div>
                     </div>
