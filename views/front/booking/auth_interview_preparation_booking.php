   ...
   <body>
      ...
      <article class="pb-0">
         ...
         <div class="tab-content" id="myTabContent">
            ...
            <form method="post" id="paymentFrm"  enctype="multipart/form-data" action="<?=isset($user_data['id'])?(base_url()."home/auth_checkout_interview_preparation"):(base_url()."home/checkout_interview_preparation")?>">
            ...
            <div class="form mt-2">
                  ...
                  <div class="form-row form-account-create">
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text" name="email" id="email" class="form-control"  data-email="<?=isset($user_data['email'])?$user_data['email']:'';?>" value="<?=isset($user_data['email'])?$user_data['email']:'';?>">
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text"  name="country_of_residence" id="country_of_residence" class="form-control" value="<?=isset($user_data['country_of_residence'])?set_value($user_data['country_of_residence']):'';?>" data-country_of_residence="<?=isset($user_data['country_of_residence'])?$user_data['country_of_residence']:'';?>" placeholder="Canada">
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="number" name="phone_no" id="phone_no" class="form-control" value="<?=isset($user_data['mobile'])?set_value($user_data['mobile']):'';?>" data-phone_no="<?=isset($user_data['mobile'])?$user_data['mobile']:'';?>" placeholder="+44 (0) 7123 456 789">
