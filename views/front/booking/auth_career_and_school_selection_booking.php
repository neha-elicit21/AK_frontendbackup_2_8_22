            ...
            <input type="radio" name="our_packages_price" value="<?php echo $OPdata[0]['our_packages_price']; ?>" checked="" hidden>
                        ...
                        <div class="row mb-5 pb-5">
                           ...
                           <div class="col-lg-3 col-md-6 col-sm-12">
                              ...
                              <div class="considered-box" style="min-height: 100px;">
         ...
         <ul class="packages-list">
          ...
          <!--   
            <a href="#" title="Select your  package " class="btn-learnMore" id="packege" data-packege="<?=$row['our_packages_id']?>" >Select your package
              ...
              <p style="position: relative;opacity:<?php if($our_packages_id!=$row['our_packages_id']){ echo "0.3"; }?>"> 
            ...
            <div class="form mt-2">
                  ...
                  <div class="form-row form-account-create">
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="password" name="password" id="password" class="form-control" value="<?=isset($user_data['password'])?($user_data['password']):('')?>"  data-password="<?=isset($user_data['password'])?$user_data['password']:'';?>"  disabled>
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text"  name="lname" id="lname" value="<?=isset($user_data['last_name'])&& !empty($user_data['last_name']?(set_value($user_data['last_name'])):(''))?>" data-lname="<?=isset($user_data['last_name'])?$user_data['last_name']:'';?>" class="form-control"  placeholder="Garner-Jones" disabled>
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text"  name="fname" id="fname" value="<?=isset($user_data['name'])&& !empty($user_data['name']?(set_value($user_data['name'])):(''))?>" data-fname="<?=isset($user_data['name'])?$user_data['name']:'';?>" class="form-control"  placeholder="Louise" disabled>
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text"  name="country_of_residence" id="country_of_residence" class="form-control" value="<?=isset($user_data['country_of_residence'])?set_value($user_data['country_of_residence']):'';?>" data-country_of_residence="<?=isset($user_data['country_of_residence'])?$user_data['country_of_residence']:'';?>" placeholder="Canada" disabled>
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="tel" name="phone_no" id="phone_no" class="form-control" value="<?=(isset($user_data['mobile']))?($user_data['mobile']):('')?>" data-phone_no="<?=isset($user_data['mobile'])?$user_data['mobile']:'';?>"  disabled>
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text" name="current_school_university" id="current_school_university" class="form-control" value=""  data-current_school_university="" placeholder="McGill University" disabled>
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text" name="current_gpa" id="current_gpa" class="form-control" value="" data-current_gpa="<?=isset($user_data['current_gpa'])?$user_data['current_gpa']:'';?>" placeholder="1.0" disabled>
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text" name="current_major" id="current_major" class="form-control" value=""  data-current_major="<?=isset($user_data['current_major'])?$user_data['current_major']:'';?>"placeholder="Mathematics" disabled>
               ...
               <div class="row ">
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     ...
                     <div class="selected-package">
                        ...
                        <a href="<?php echo base_url('career-and-school-selection');?>" title="Select package" class="select-package-btn">Change  package 
