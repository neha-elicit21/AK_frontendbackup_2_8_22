   ...
   <body>
      ...
      <article class="pb-0">
         ...
         <div class="tab-content" id="myTabContent">
            ...
            <form method="post" id="paymentFrm"  enctype="multipart/form-data" action="<?php echo base_url(); ?>home/checkout_interview_preparation">
                              ...
                              <div class="form-row" style="flex-wrap: nowrap;">
                                 ...
                                 <div class="col-md-6 mb-5" id="schoolData1">
                                    ...
                                    <select class="form-select bg-white" name="considered_school[]" id="select-school"  onchange="SubjectSelect(this.id)" aria-label="Default select example" required="required">
                                       ...
                                       <option class="sortMe" selected value="American University">American University</option>
                           ...
                           <option class="sortMe" value="Baylor University">Baylor University</option>
                             ...
                             <option class="sortMe" id='University of Reading' value="University of Reading">University of Reading</option>
                                    ...
                                    <select class="form-select bg-white" name="intended_major[]" aria-label="Default select example"  id="select-major" required="required">
                                       ...
                                       <option  value="0" disabled>Select your major</option>
            ...
            <div class="form mt-2">
                  ...
                  <div class="form-row form-account-create">
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="password" name="password" id="password" class="form-control" value="<?=isset($user_data['password'])&& !empty($user_data['password']?(set_value($user_data['password'])):(''))?>"  data-password="<?=isset($user_data['password'])?$user_data['password']:'';?>" required>
               ...
               <div class="row ">
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     ...
                     <div class="selected-package">
                        ...
                        <a href="<?php echo base_url('/interview-preparation/#Ourpackages');?>" title="Select package" class="select-package-btn">Change  package 
...
<footer>
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"
   ...
   <script language="javascript" src="<?php echo base_url('assets') ?>/js/custom.js"></script>
    ...
    <script language="javascript" src="<?php echo base_url('front/assets/js/interview_preparation_booking.js') ?>"></script>
   ...
   // alert('selected ' + info.startStr + ' to ' + info.endStr +'hiiiiii'+titlEventModal);
      ...
      right: ''
       ...
       //code for mobile view
        ...
        // alert(moment().diff(select.start, 'days'));
