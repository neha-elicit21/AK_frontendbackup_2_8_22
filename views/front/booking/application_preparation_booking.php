   ...
   <body>
      ...
      <article class="pb-0">
         ...
         <div class="tab-content" id="myTabContent">
            ...
            <form method="post" id="paymentFrm"  enctype="multipart/form-data" action="<?php echo base_url(); ?>home/application_checkout">
                          ...
                          /*print_r($data);*/
                           ...
                           <div class="col-lg-3 col-md-6 col-sm-12">
                              ...
                              <div class="considered-box" style="opacity:<?php if($consider_deg_id!=$row['our_packages_id']){ echo "0.3"; }?>">
                                 ...
                                 <input type="radio" title="Select package" data-val="<?= $row['our_packages_name'] ?>" name="considered_degree"  class="select-package-input" id="selectbsc-bs"  value="<?= $row['our_packages_id'] ?>"  <?php if($consider_deg_id==$row['our_packages_id']){ echo "checked"; } else echo "disabled"; ?>>

                                 <a  href="javascript:void(0)" title="Select package"  class="select-package-btn" id="selectbsc-bs" onclick="SubjectSelect(this.id)"><span><?php if($consider_deg_id==$row['our_packages_id']){ echo "Selected  Degree"; } else echo "Select  Degree"; ?></span>
                                 ...
                                 <div class="col-md-6 mb-5" id="schoolData1">
                                    ...
                                    <select class="form-select bg-white" name="considered_school[]" id="select-school"  onchange="SubjectSelect(this.id)" aria-label="Default select example" required="required">
                                       ...
                                       <option value="0">Select a school</option>
                                        <option class="sortMe" value="Massachusetts Institute of Technology">Massachusetts Institute of Technology</option>
                                       <option class="sortMe" value="Harvard University">Harvard University</option>
                                       <option class="sortMe" value="Stanford University">Stanford University</option>
      ...
      <div class="container">
       ...
       /*  foreach($Fixed_price_new as $price_new){
                     ...
                     <div id="collapse<?= $Fixed_data['price_packages_id'] ?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                        ...
                        <div class="card-body">
                           ...
                           <?php foreach($newFix as $ac) {
                             ...
                             //$ac['price_packages_id_ref']== $Fixed_data['price_packages_id']

                               if( $ac['price_package_type']==1 && $ac['price_packages_id_ref']== $Fixed_data['price_packages_id'] && $ac['page_id']==$consider_deg_id && $ac['is_status']==1)
                                    ...
                                    //   echo $ac['price_package_type'];
                                       ...
                                       for($i=0;$i <count($includ);$i++){ ?>
                                          ...
                                          <li>
                                             ...
                                             <input type="checkbox" data-name="<?= $ac['price_packages_name'] ?>" data-price="<?=$essay_price[$i] ?>" name="price_package_id" value="<?= $ac['price_packages_id'] ?>" id="<?= $i ?>" onclick="PackageRadioFn(this.id)" />
            ...
            <!--    <p style="position: relative;">
               ...
               <p style="position: relative;" id="<?= $Fixed_data['price_packages_id'] ?>" onclick="selectedPackages(this.id)">

                  <input type="radio" name="price_package_id" class="select-package-input" data-val="<?= $Fixed_data['price_packages_name'] ?>" data-price="<?= $price ?>" value="<?= $Fixed_data['price_packages_id'] ?>">

              

                  <a  href="javascript:void(0)" title="Select package"  class="select-package-btn" id="select-degree" onclick="SubjectSelect(this.id)">
                  	
                  	<span class="select-span" id="select-degree<?= $Fixed_data['price_packages_id'] ?>">Select  Degree </span>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
               ...
               <div class="packages-box uplode-img plus-icon file-upload-wrapper add-packeges">
      ...
      <section class="booking-content">
         ...
         <div class="container">
            ...
            <div class="row">
               ...
               <?php   
               foreach($professor as $professorData) { 
               ...
               <div class="col-lg-2 col-md-3 col-sm-6">
                  ...
                  <div class="professor-box">
                     ...
                     <p style="position: relative;" onclick="selectedprofessor(this.id)" id="<?=$professorData['professor_our_experts_id']?>">

                     <input type="radio" class="select-package-input" name="professor_id"  value="<?= $professorData['professor_our_experts_id']  ?>" />

                     <a href="javascript:void(0)" title="Select package" class="select-package-btn" id="select-professor<?=$professorData['professor_our_experts_id']?>">Select  professor 
               ...
               <div class="row border-0">
                  ...
                  <div class="col-lg-5 col-md-5 col-sm-5 heading">
                     ...
                     <div class="row times-select">
                         ...
                         <div class="col-lg-6 col-md-6 col-sm-6 slect-time-right cal-time">
                            <?php
            ...
            <div class="form mt-2">
                  ...
                  <div class="form-row form-account-create">
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="tel" name="phone_no" id="phone_no" class="form-control" value="" placeholder="7123-456-789">
               ...
               <div class="row ">
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     ...
                     <div class="selected-package">
                        ...
                        <a href="<?=base_url('/application-preparation/#Ourpackages')?>" title="Select package" class="select-package-btn">Change  package 
                           ...
                           <ul class="country-btn-list">
                            ...
                            <!--   <li>
                             ...
                             <li>
                                 ...
                                 <a href="javascript:void(0)" title="Select package" class="select-package-btn">Pay in  4 installments Every 2 Weeks
...
$(document).ready(function(){
    $(".col-lg-3 col-md-6 col-sm-12").click(function () {
        const price_package_id = $("input[name='price_package_id']:checked").val();
        if ($("#select-degree1").is(":checked")) {
          $('.select-span').html('Select Degree');
          $('span', this).html('Selected Degree');
        } else if ($("#select-degree2").is(":checked")) {
           $('.select-span').html('Select Degree');
           $('span', this).html('Selected Degree');
        }else if ($("#select-degree3").is(":checked")) {
           $('.select-span').html('Select Degree');
           $('span', this).html('Selected Degree');
        }
        else
