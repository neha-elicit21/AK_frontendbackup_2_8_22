    ...
    <!--      <input name="<?php //echo $this->security->get_csrf_token_name(); ?>" id="csrf_token" type="hidden" value="<?php //echo $this->security->get_csrf_hash(); ?>" /> -->
            ...
            <input type="radio" name="our_packages_price" value="<?php echo $OPdata[0]['our_packages_price']; ?>" checked="" hidden>
                        ...
                        <div class="row">
                                 ...
                                 <div class="col-md-6 mb-5" id="schoolData1">
                                    ...
                                    <select class="form-select bg-white" name="considered_school[]" id="select-school"  onchange="SubjectSelect(this.id)" aria-label="Default select example" required="required">
                                       ...
                                       <option  value="University of Washington"> University of Washington</option>
                                          ...
                                          <option  value="The University of British Columbia">The University of British Columbia</option>
                                       ...
                                       <option value="The University of Queensland">The University of Queensland</option>
                                       <option value="Georgia State University">Georgia State University</option>
                                       <option value="William Marsh Rice University">William Marsh Rice University</option>
                                       ...
                                       <option value="Vanderbilt University">Vanderbilt University</option>
                                          ...
                                          <option value="The London School of Economics and Political Science">The London School of Economics and Political Science</option>
                           ...
                           <option value="Trinity College Dublin, University of Dublin">Trinity College Dublin, University of Dublin</option>
                           ...
                           <option value="The University of Tennessee at Martin">The University of Tennessee at Martin</option>
            ...
            <div class="form mt-2">
                  ...
                  <div class="form-row form-account-create">
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text" name="email" id="email" class="form-control"  data-email="<?=isset($user_data['email'])?$user_data['email']:'';?>" placeholder="University of Oxford">
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="tel" name="phone_no" id="phone_no" class="form-control" value="" data-phone_no="<?=isset($user_data['phone_no'])?$user_data['phone_no']:'';?>" placeholder="+44 (0) 7123 456 789">
