   ...
   <body>
      ...
      <article class="pb-0">
         ...
         <div class="tab-content" id="myTabContent">
            ...
            <form method="post" id="paymentFrm"  enctype="multipart/form-data" action="<?php echo base_url(); ?>home/auth_test_prepration_checkout">
                           ...
                           <div class="col-lg-3 col-md-6 col-sm-12">
                              ...
                              <div class="considered-box" style="opacity:<?php if($our_packages_id!=$row['our_packages_id']){ echo '0.3' ; } ?>">
                               ...
                               <!--   <p>
                                 ...
                                 <input type="radio" title="Select package" data-val="<?= $row['our_packages_name'] ?>" name="considered_degree"  class="select-package-input" id="selectbsc-bs"  value="<?= $row['our_packages_id'] ?>"<?php if($our_packages_id==$row['our_packages_id']){ echo "checked"; } else echo "disabled"; ?>>

                                 <a  href="javascript:void(0)" title="Select package"  class="select-package-btn" id="selectbsc-bs" onclick="SubjectSelect(this.id)"><span><?php if($our_packages_id==$row['our_packages_id']){ echo "Selected  package"; } else echo "Select  package"; ?></span>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12" data-aos="fade-up" data-aos-duration="1000">
         ...
         <ul class="packages-list">
          ...
          <p style="position: relative;"> 
                  <input type="radio" name="price_package_id" class="select-package-input" data-val="<?= $row['price_packages_name'] ?>" data-price=" <?= $row['price_packages'] ?>" value="<?= $row['price_packages_id'] ?>">
            ...
            <div class="form mt-2">
                  ...
                  <div class="form-row form-account-create">
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="password" name="password" id="password" class="form-control" value="<?=($user_data['password'] && !empty($user_data['password']))?$user_data['password']:'';?>"  data-password="<?=isset($user_data['password'])?$user_data['password']:'';?>"  disabled>
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text"  name="lname" id="lname" value="<?=(isset($user_data['last_name'])&& !empty($user_data['last_name'])?($user_data['last_name']):(''))?>" data-lname="<?=isset($user_data['last_name'])?$user_data['last_name']:'';?>" class="form-control" value="" placeholder="Garner-Jones" disabled>
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text"  name="fname" id="fname" value="<?=(isset($user_data['name'])&& !empty($user_data['name'])?($user_data['name']):(''))?>" data-fname="<?=isset($user_data['name'])?$user_data['name']:'';?>" class="form-control" value="" placeholder="Louise" disabled>
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text"  name="country_of_residence" id="country_of_residence" class="form-control" value="<?=(isset($user_data['country_of_residence'])&& !empty($user_data['country_of_residence'])?($user_data['country_of_residence']):(''))?>" data-country_of_residence="<?=isset($user_data['country_of_residence'])?$user_data['country_of_residence']:'';?>" placeholder="Canada" disabled>
               ...
               <div class="row ">
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     ...
                     <div class="selected-package">
                        ...
                        <a href="<?php echo base_url('test-preparation');?>" title="Select package" class="select-package-btn">Change  package 
