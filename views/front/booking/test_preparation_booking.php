   ...
   <body>
      ...
      <article class="pb-0">
         ...
         <div class="tab-content" id="myTabContent">
            ...
            <form method="post" id="paymentFrm"  enctype="multipart/form-data" action="<?php echo base_url(); ?>home/test_prepration_checkout">
            ...
            <input type="radio" name="our_packages_price" value="<?php echo $OPdata[0]['our_packages_id']; ?>" checked="" hidden>
                        ...
                        <div class="row mb-5 pb-5">
                           ...
                           <div class="col-lg-3 col-md-6 col-sm-12">
                              ...
                              <div class="considered-box" style="opacity:<?php if($our_packages_id!=$row['our_packages_id']){ echo '0.3' ; } ?>">
                               ...
                               <!--   <p>
                                 ...
                                 <input type="radio" title="Select package" onclick="selectedPackages(this.id)" data-val="<?= $row['our_packages_name'] ?>" name="considered_degree"  class="select-package-input" id="selectbsc-bs"  value="<?= $row['our_packages_id'] ?>"<?php if($our_packages_id==$row['our_packages_id']){ echo "checked"; } else echo "disabled"; ?>>

                                 <a  href="javascript:void(0)" title="Select package"  class="select-package-btn" id="selectbsc-bs" onclick="SubjectSelect(this.id)"><span><?php if($our_packages_id==$row['our_packages_id']){ echo "Selected  Degree"; } else echo "Select  Degree"; ?> </span>
   ...
   <section class="booking-content">
      <div class="container">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12" data-aos="fade-up" data-aos-duration="1000">
         <div class="test_prepration" style="position:relative; height: 100%;">
             <div class="packages-box">
            <h3 class="package-heading">
              <?php echo $row[ 'price_packages_name']?>
            
            <span>
                       <span>€ <?= $row['price_packages']?></span>
                     
            </span></h3>
         <ul class="packages-list">
              <?php $includ=explode( '_',$row[ 'price_packages_content']); for($i=0;$i<count($includ);$i++){ echo "<li>".$includ[$i]. "</li>"; }?>
            </ul>
          ...
          <p style="position: absolute;left: 0;bottom: 0;right: 0;"> 
                  <input type="radio" name="price_package_id" onclick="selectedPackages(this.id)" id="<?= $row['price_packages_id']?>" class="select-package-input" data-val="<?= $row['price_packages_name'] ?>" data-price=" <?= $row['price_packages'] ?>" value="<?= $row['price_packages_id'] ?>">
                  <a  href="javascript:void(0)" title="Select package" id="select-package<?= $row['price_packages_id']?>" class="select-package-btn">Select package 
                  <i class="fas fa-chevron-right"></i>
                  </a>
               </p>
         </div>
            ...
            <div class="form mt-2">
                  ...
                  <div class="form-row form-account-create">
                     ...
                     <div class="col-md-6 mb-5">
                        ...
                        <input type="text" name="email" id="email" class="form-control"  data-email="" placeholder="admin@gmail.com">
               ...
               <div class="row ">
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     ...
                     <div class="selected-package">
                        ...
                        <a href="<?php echo base_url('/test-preparation/#Ourpackages');?>" title="Select package" class="select-package-btn">Change  package 
...
<footer>
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"
    ...
    <script language="javascript" src="<?php echo base_url('front/assets/js/test_selection_booking_booking.js') ?>"></script>
