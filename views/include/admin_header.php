        ...
        <nav id="navbar" class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item <?php if($this->uri->segment(2)=='dashboard') echo "active" ?>"> <a title="" class="nav-link" href="<?php echo base_url('admin/dashboard'); ?>">Students</a> </li>

              < <li class="nav-item <?php if($this->uri->segment(2)=='myprofile') echo "active" ?>"> <a title="" class="nav-link" href="<?= base_url('admin/myprofile');?>">Professors</a> </li>

              <li class="nav-item <?php if($this->uri->segment(2)=='myschedule') echo "active" ?>"> <a title="" class="nav-link" href="<?= base_url('admin/myschedule'); ?>">CRM</a> </li>
            ...
            <img class="user-img" src="<?php echo base_url('assets/images/'.$header_data['profile']); ?>" /><?php } ?> </a>
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a title="" class="dropdown-item" href="<?= base_url('admin/reset')?>">Change Password</a></li>
